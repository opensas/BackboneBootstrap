var Handlebars={VERSION:"1.0.beta.6",helpers:{},partials:{},registerHelper:function(a,b,e){e&&(b.not=e);this.helpers[a]=b},registerPartial:function(a,b){this.partials[a]=b}};Handlebars.registerHelper("helperMissing",function(a){if(2!==arguments.length)throw Error("Could not find property '"+a+"'");});var toString=Object.prototype.toString,functionType="[object Function]";
Handlebars.registerHelper("blockHelperMissing",function(a,b){var e=b.inverse||function(){},d=b.fn,f="",c=toString.call(a);c===functionType&&(a=a.call(this));if(!0===a)return d(this);if(!1===a||null==a)return e(this);if("[object Array]"===c){if(0<a.length){e=0;for(c=a.length;e<c;e++)f+=d(a[e])}else f=e(this);return f}return d(a)});Handlebars.registerHelper("each",function(a,b){var e=b.fn,d=b.inverse,f="";if(a&&0<a.length)for(var d=0,c=a.length;d<c;d++)f+=e(a[d]);else f=d(this);return f});
Handlebars.registerHelper("if",function(a,b){toString.call(a)===functionType&&(a=a.call(this));return!a||Handlebars.Utils.isEmpty(a)?b.inverse(this):b.fn(this)});Handlebars.registerHelper("unless",function(a,b){var e=b.fn;b.fn=b.inverse;b.inverse=e;return Handlebars.helpers["if"].call(this,a,b)});Handlebars.registerHelper("with",function(a,b){return b.fn(a)});Handlebars.registerHelper("log",function(a){Handlebars.log(a)});
...
b,e,d,f,c){a=c.length-1;switch(f){case 1:return c[a-1];case 2:this.$=new d.ProgramNode(c[a-2],c[a]);break;case 3:this.$=new d.ProgramNode(c[a]);break;case 4:this.$=new d.ProgramNode([]);break;case 5:this.$=[c[a]];break;case 6:c[a-1].push(c[a]);this.$=c[a-1];break;case 7:this.$=new d.InverseNode(c[a-2],c[a-1],c[a]);break;case 8:this.$=new d.BlockNode(c[a-2],c[a-1],c[a]);break;case 9:this.$=c[a];break;case 10:this.$=c[a];break;case 11:this.$=new d.ContentNode(c[a]);break;case 12:this.$=new d.CommentNode(c[a]);
break;case 13:this.$=new d.MustacheNode(c[a-1][0],c[a-1][1]);break;case 14:this.$=new d.MustacheNode(c[a-1][0],c[a-1][1]);break;case 15:this.$=c[a-1];break;case 16:this.$=new d.MustacheNode(c[a-1][0],c[a-1][1]);break;case 17:this.$=new d.MustacheNode(c[a-1][0],c[a-1][1],!0);break;case 18:this.$=new d.PartialNode(c[a-1]);break;case 19:this.$=new d.PartialNode(c[a-2],c[a-1]);break;case 21:this.$=[[c[a-2]].concat(c[a-1]),c[a]];break;case 22:this.$=[[c[a-1]].concat(c[a]),null];break;case 23:this.$=[[c[a-
1]],c[a]];break;case 24:this.$=[[c[a]],null];break;case 25:c[a-1].push(c[a]);this.$=c[a-1];break;case 26:this.$=[c[a]];break;case 27:this.$=c[a];break;case 28:this.$=new d.StringNode(c[a]);break;case 29:this.$=new d.IntegerNode(c[a]);break;case 30:this.$=new d.BooleanNode(c[a]);break;case 31:this.$=new d.HashNode(c[a]);break;case 32:c[a-1].push(c[a]);this.$=c[a-1];break;case 33:this.$=[c[a]];break;case 34:this.$=[c[a-2],c[a]];break;case 35:this.$=[c[a-2],new d.StringNode(c[a])];break;case 36:this.$=
[c[a-2],new d.IntegerNode(c[a])];break;case 37:this.$=[c[a-2],new d.BooleanNode(c[a])];break;case 38:this.$=new d.IdNode(c[a]);break;case 39:c[a-2].push(c[a]);this.$=c[a-2];break;case 40:this.$=[c[a]]}},table:[{3:1,4:2,5:[2,4],6:3,8:4,9:5,11:6,12:7,13:8,14:[1,9],15:[1,10],16:[1,12],19:[1,11],22:[1,13],23:[1,14],24:[1,15]},{1:[3]},{5:[1,16]},{5:[2,3],7:17,8:18,9:5,11:6,12:7,13:8,14:[1,9],15:[1,10],16:[1,12],19:[1,19],20:[2,3],22:[1,13],23:[1,14],24:[1,15]},{5:[2,5],14:[2,5],15:[2,5],16:[2,5],19:[2,
...
15],22:[2,15],23:[2,15],24:[2,15]},{18:[2,34],33:[2,34]},{18:[2,35],33:[2,35]},{18:[2,36],33:[2,36]},{18:[2,37],33:[2,37]}],defaultActions:{16:[2,1],37:[2,23],53:[2,21]},parseError:function(a){throw Error(a);},parse:function(a){var b=[0],e=[null],d=[],f=this.table,c="",i=0,h=0,o=0;this.lexer.setInput(a);this.lexer.yy=this.yy;this.yy.lexer=this.lexer;"undefined"==typeof this.lexer.yylloc&&(this.lexer.yylloc={});a=this.lexer.yylloc;d.push(a);"function"===typeof this.yy.parseError&&(this.parseError=
this.yy.parseError);for(var j,p,m,g,l={},n,k;;){m=b[b.length-1];this.defaultActions[m]?g=this.defaultActions[m]:(null==j&&(j=void 0,j=this.lexer.lex()||1,"number"!==typeof j&&(j=this.symbols_[j]||j)),g=f[m]&&f[m][j]);if(("undefined"===typeof g||!g.length||!g[0])&&!o){k=[];for(n in f[m])this.terminals_[n]&&2<n&&k.push("'"+this.terminals_[n]+"'");var q="",q=this.lexer.showPosition?"Parse error on line "+(i+1)+":\n"+this.lexer.showPosition()+"\nExpecting "+k.join(", ")+", got '"+this.terminals_[j]+"'":
"Parse error on line "+(i+1)+": Unexpected "+(1==j?"end of input":"'"+(this.terminals_[j]||j)+"'");this.parseError(q,{text:this.lexer.match,token:this.terminals_[j]||j,line:this.lexer.yylineno,loc:a,expected:k})}if(g[0]instanceof Array&&1<g.length)throw Error("Parse Error: multiple actions possible at state: "+m+", token: "+j);switch(g[0]){case 1:b.push(j);e.push(this.lexer.yytext);d.push(this.lexer.yylloc);b.push(g[1]);j=null;p?(j=p,p=null):(h=this.lexer.yyleng,c=this.lexer.yytext,i=this.lexer.yylineno,
a=this.lexer.yylloc,0<o&&o--);break;case 2:k=this.productions_[g[1]][1];l.$=e[e.length-k];l._$={first_line:d[d.length-(k||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(k||1)].first_column,last_column:d[d.length-1].last_column};m=this.performAction.call(l,c,h,i,this.yy,g[1],e,d);if("undefined"!==typeof m)return m;k&&(b=b.slice(0,-2*k),e=e.slice(0,-1*k),d=d.slice(0,-1*k));b.push(this.productions_[g[1]][0]);e.push(l.$);d.push(l._$);g=f[b[b.length-2]][b[b.length-1]];b.push(g);
...
(function(){Handlebars.AST={};Handlebars.AST.ProgramNode=function(a,e){this.type="program";this.statements=a;if(e)this.inverse=new Handlebars.AST.ProgramNode(e)};Handlebars.AST.MustacheNode=function(a,e,d){this.type="mustache";this.id=a[0];this.params=a.slice(1);this.hash=e;this.escaped=!d};Handlebars.AST.PartialNode=function(a,e){this.type="partial";this.id=a;this.context=e};var a=function(a,e){if(a.original!==e.original)throw new Handlebars.Exception(a.original+" doesn't match "+e.original);};Handlebars.AST.BlockNode=
function(b,e,d){a(b.id,d);this.type="block";this.mustache=b;this.program=e};Handlebars.AST.InverseNode=function(b,e,d){a(b.id,d);this.type="inverse";this.mustache=b;this.program=e};Handlebars.AST.ContentNode=function(a){this.type="content";this.string=a};Handlebars.AST.HashNode=function(a){this.type="hash";this.pairs=a};Handlebars.AST.IdNode=function(a){this.type="ID";this.original=a.join(".");for(var e=[],d=0,f=0,c=a.length;f<c;f++){var i=a[f];i===".."?d++:i==="."||i==="this"?this.isScoped=true:
e.push(i)}this.parts=e;this.string=e.join(".");this.depth=d;this.isSimple=e.length===1&&d===0};Handlebars.AST.StringNode=function(a){this.type="STRING";this.string=a};Handlebars.AST.IntegerNode=function(a){this.type="INTEGER";this.integer=a};Handlebars.AST.BooleanNode=function(a){this.type="BOOLEAN";this.bool=a};Handlebars.AST.CommentNode=function(a){this.type="comment";this.comment=a}})();
Handlebars.Exception=function(a){var b=Error.prototype.constructor.apply(this,arguments),e;for(e in b)b.hasOwnProperty(e)&&(this[e]=b[e]);this.message=b.message};Handlebars.Exception.prototype=Error();Handlebars.SafeString=function(a){this.string=a};Handlebars.SafeString.prototype.toString=function(){return this.string.toString()};
(function(){var a={"<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"},b=/&(?!\w+;)|[<>"'`]/g,e=/[&<>"'`]/,d=function(b){return a[b]||"&amp;"};Handlebars.Utils={escapeExpression:function(a){return a instanceof Handlebars.SafeString?a.toString():a==null||a===false?"":!e.test(a)?a:a.replace(b,d)},isEmpty:function(a){return typeof a==="undefined"?true:a===null?true:a===false?true:Object.prototype.toString.call(a)==="[object Array]"&&a.length===0?true:false}}})();Handlebars.Compiler=function(){};
...
{};for(var e in a.OPCODE_MAP)a.DISASSEMBLE_MAP[a.OPCODE_MAP[e]]=e;a.multiParamSize=function(i){return a.MULTI_PARAM_OPCODES[a.DISASSEMBLE_MAP[i]]};a.prototype={compiler:a,disassemble:function(){for(var i=this.opcodes,h,b=[],c,d=0,e=i.length;d<e;d++){h=i[d];if(h==="DECLARE"){c=i[++d];h=i[++d];b.push("DECLARE "+c+" = "+h)}else{c=a.DISASSEMBLE_MAP[h];for(var f=a.multiParamSize(h),l=[],n=0;n<f;n++){h=i[++d];typeof h==="string"&&(h='"'+h.replace("\n","\\n")+'"');l.push(h)}c=c+" "+l.join(" ");b.push(c)}}return b.join("\n")},
guid:0,compile:function(a,h){this.children=[];this.depths={list:[]};this.options=h;var b=this.options.knownHelpers;this.options.knownHelpers={helperMissing:true,blockHelperMissing:true,each:true,"if":true,unless:true,"with":true,log:true};if(b)for(var c in b)this.options.knownHelpers[c]=b[c];return this.program(a)},accept:function(a){return this[a.type](a)},program:function(a){var a=a.statements,h;this.opcodes=[];for(var b=0,c=a.length;b<c;b++){h=a[b];this[h.type](h)}this.isSimple=c===1;this.depths.list=
this.depths.list.sort(function(a,i){return a-i});return this},compileProgram:function(a){var a=(new this.compiler).compile(a,this.options),b=this.guid++;this.usePartial=this.usePartial||a.usePartial;this.children[b]=a;for(var c=0,d=a.depths.list.length;c<d;c++){depth=a.depths.list[c];depth<2||this.addDepth(depth-1)}return b},block:function(a){var b=a.mustache,c=this.setupStackForMustache(b),d=this.compileProgram(a.program);if(a.program.inverse){a=this.compileProgram(a.program.inverse);this.declare("inverse",
...
c){return/^[0-9]+$/.test(c)?a+"["+c+"]":b.isValidJavaScriptVariableName(c)?a+"."+c:a+"['"+c+"']"},appendToBuffer:function(a){return this.environment.isSimple?"return "+a+";":"buffer += "+a+";"},initializeBuffer:function(){return this.quotedString("")},namespace:"Handlebars",compile:function(a,b,d,e){this.environment=a;this.options=b||{};this.name=this.environment.name;this.isChild=!!d;this.context=d||{programs:[],aliases:{self:"this"},registers:{list:[]}};this.preamble();this.stackSlot=0;this.stackVars=
[];this.compileChildren(a,b);a=a.opcodes;this.i=0;for(c=a.length;this.i<c;this.i++){a=this.nextOpcode(0);if(a[0]==="DECLARE"){this.i=this.i+2;this[a[1]]=a[2]}else{this.i=this.i+a[1].length;this[a[0]].apply(this,a[1])}}return this.createFunctionContext(e)},nextOpcode:function(b){var c=this.environment.opcodes,d=c[this.i+b],e,f;if(d==="DECLARE"){e=c[this.i+1];b=c[this.i+2];return["DECLARE",e,b]}e=a.DISASSEMBLE_MAP[d];d=a.multiParamSize(d);f=[];for(var m=0;m<d;m++)f.push(c[this.i+m+1+b]);return[e,f]},
...
e||this.options.stringParams||d||this.options.data,l=this.popStack(),n=[],k;if(g){this.register("tmp1",c);k="tmp1"}else k="{ hash: {} }";if(g){e=e?this.popStack():"{}";this.source.push("tmp1.hash = "+e+";")}this.options.stringParams&&this.source.push("tmp1.contexts = [];");for(g=0;g<a;g++){e=this.popStack();n.push(e);this.options.stringParams&&this.source.push("tmp1.contexts.push("+this.popStack()+");")}if(d){this.source.push("tmp1.fn = tmp1;");this.source.push("tmp1.inverse = "+d+";")}this.options.data&&
this.source.push("tmp1.data = data;");n.push(k);this.populateCall(n,l,b||l,f,c!=="{}")},populateCall:function(a,b,c,d,e){var f=["depth0"].concat(a).join(", "),a=["depth0"].concat(c).concat(a).join(", "),c=this.nextStack();if(this.usingKnownHelper)this.source.push(c+" = "+b+".call("+f+");");else{this.context.aliases.functionType='"function"';this.source.push("if("+(e?"foundHelper && ":"")+"typeof "+b+" === functionType) { "+c+" = "+b+".call("+f+"); }")}d.call(this,c,a,b);this.usingKnownHelper=false},
invokePartial:function(a){params=[this.nameLookup("partials",a,"partial"),"'"+a+"'",this.popStack(),"helpers","partials"];this.options.data&&params.push("data");this.pushStack("self.invokePartial("+params.join(", ")+");")},assignToHash:function(a){var b=this.popStack(),c=this.topStack();this.source.push(c+"['"+a+"'] = "+b+";")},compiler:b,compileChildren:function(a,b){for(var c=a.children,d,e,f=0,g=c.length;f<g;f++){d=c[f];e=new this.compiler;this.context.programs.push("");var l=this.context.programs.length;
d.index=l;d.name="program"+l;this.context.programs[l]=e.compile(d,b,this.context)}},programExpression:function(a){if(a==null)return"self.noop";for(var b=this.environment.children[a],a=b.depths.list,b=[b.index,b.name,"data"],c=0,d=a.length;c<d;c++){depth=a[c];depth===1?b.push("depth0"):b.push("depth"+(depth-1))}if(a.length===0)return"self.program("+b.join(", ")+")";b.shift();return"self.programWithDepth("+b.join(", ")+")"},register:function(a,b){this.useRegister(a);this.source.push(a+" = "+b+";")},
...
a.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r")+'"'}};e=["break","else","new","var","case","finally","return","void","catch","for","switch","while","continue","function","this","with","default","if","throw","delete","in","try","do","instanceof","typeof","abstract","enum","int","short","boolean","export","interface","static","byte","extends","long","super","char","final","native","synchronized","class","float","package","throws","const","goto","private","transient",
"debugger","implements","protected","volatile","double","import","public","let","yield"];for(var d=b.RESERVED_WORDS={},f=0,c=e.length;f<c;f++)d[e[f]]=true;b.isValidJavaScriptVariableName=function(a){return!b.RESERVED_WORDS[a]&&/^[a-zA-Z_$][0-9a-zA-Z_$]+$/.test(a)?true:false}})(Handlebars.Compiler,Handlebars.JavaScriptCompiler);Handlebars.precompile=function(a,b){var b=b||{},e=Handlebars.parse(a),e=(new Handlebars.Compiler).compile(e,b);return(new Handlebars.JavaScriptCompiler).compile(e,b)};
Handlebars.compile=function(a,b){var b=b||{},e;return function(d,f){if(!e){var c=Handlebars.parse(a),c=(new Handlebars.Compiler).compile(c,b),c=(new Handlebars.JavaScriptCompiler).compile(c,b,void 0,true);e=Handlebars.template(c)}return e.call(this,d,f)}};
Handlebars.VM={template:function(a){var b={escapeExpression:Handlebars.Utils.escapeExpression,invokePartial:Handlebars.VM.invokePartial,programs:[],program:function(a,b,f){var c=this.programs[a];if(f)return Handlebars.VM.program(b,f);c||(c=this.programs[a]=Handlebars.VM.program(b));return c},programWithDepth:Handlebars.VM.programWithDepth,noop:Handlebars.VM.noop};return function(e,d){d=d||{};return a.call(b,Handlebars,e,d.helpers,d.partials,d.data)}},programWithDepth:function(a,b,e){var d=Array.prototype.slice.call(arguments,
2);return function(e,c){c=c||{};return a.apply(this,[e,c.data||b].concat(d))}},program:function(a,b){return function(e,d){d=d||{};return a(e,d.data||b)}},noop:function(){return""},invokePartial:function(a,b,e,d,f,c){options={helpers:d,partials:f,data:c};if(a===void 0)throw new Handlebars.Exception("The partial "+b+" could not be found");if(a instanceof Function)return a(e,options);if(Handlebars.compile){f[b]=Handlebars.compile(a);return f[b](e,options)}throw new Handlebars.Exception("The partial "+
